...
namespace RSEnhancedPhoto.Source.CustomEventArgs
{
    ...
    /// <summary>
    /// RSEnhancedImageArg inherits from EventArgs. It's used to carry a PXCMImage back to any class that subscribes to the RSEhnancedPhoto.OnImageProcessed event. 
    /// </summary>
    public class RSEnhancedImageArg : EventArgs
    {
        // The enhanced image that was created
        private PXCMImage _image;

        /// <summary>
        /// Constructs a new RSNewEnhancedPhotoArg
        /// </summary>
        ...
        /// <summary>
        /// Getter function returns the PXCMImage that is to be used/displayed.
        /// </summary>
