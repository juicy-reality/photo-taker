...
{
    public partial class FormDepthRefocus : Form
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="photo">A fully initialized PXCMPhoto object</param>
        ...
        /// <summary>
        /// Picturebox mouse click event handler adds a point causes a refocus on that point
        /// </summary>
        ...
        private void pictureBox1_MouseClick( object sender, MouseEventArgs e )
        {
            ...
            _rsEnhanced.RefocusOnPoint( _points );
        }
        ...
        /// <summary>
        /// Scroller scroll event handler, gets the value from the scroller and forces a refocus
        /// </summary>
        private void tbAperture_Scroll( object sender, System.EventArgs e )
        {
            float size = (float) tbAperture.Value;
            lblApertureVal.Text = size.ToString( );
            _rsEnhanced.RefocusOnPoint( _points, size );
        }



        /// <summary>
        /// The event handler for the RSEnhancedPhoto.OnImageProcessed event updates the panel to display the new image
        /// </summary>
        ...
        /// </summary>
        private void FormDepthRefocus_FormClosing( object sender, FormClosingEventArgs e )
        {
            Cleanup( );
        }
